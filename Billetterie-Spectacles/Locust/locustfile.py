...
class BilletterieUser(HttpUser):
    #interface web (http://localhost:5293).
    ...
    def on_start(self):
        ...
        # Appelé au démarrage de chaque utilisateur virtuel. On récupère un token JWT pour l'utilisateur de test 'test@billetterie.com'.
